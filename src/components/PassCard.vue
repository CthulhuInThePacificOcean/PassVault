  ...
  <li class="note" :style="{ backgroundColor: card.color }">
    ...
    <div class="settings show" @click="changeView" v-if="this.isClicked">
      ...
      <ul class="menu" :style="{ backgroundColor: card.color }">
        <li @click="showPass" v-if="viewPass">
          <i class="uil uil-eye-slash"></i>Hide Password
        </li>
        <li @click="showPass" v-else>
          <i class="uil uil-eye"></i>View Password
        </li>
        <li @click="copyPass"><i class="uil uil-copy"></i>Copy Password</li>
